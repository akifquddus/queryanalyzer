...
hostName = "localhost"
hostPort = 9000
def senti(noOfSearchTerms,topicname,conscore):
    ...
    h1=noOfSearchTerms
    conscore=conscore
    noOfSearchTerms = noOfSearchTerms  + 1000    ### 50 extra tweet so the data can be processed
...
'''
topicname = input("Enter Keyword: ")
noOfSearchTerms = int(input("Enter the Number of Tweets: "))
conscore= float(input("Enter the confidance score btw 0.00 to 1.50 "))
'''
class MyServer(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.wfile.write(bytes("<body><button><a href='http://localhost/tests/test.php'>Redirecting</button>", "utf-8"))
